<?php
  ...
  if(!$imagen['size'] == 0 &&  $imagen['error']==0){
      //echo 'otra imagen';
      $imagenAnterior= "../../FrontEnd/$imagenAnterior";
      if($imagen["type"] == "image/jpg" or $imagen["type"] == "image/jpeg" or $imagen["type"] == "image/png"){
          ...
          $consulta = "UPDATE productos SET tipo = '$tipo', nombrepro = '$name', precio = '$precio', stock = '$stock', descripcion = '$descripcion', imagen = '$rutaDB' WHERE Idpro = '$id'";
